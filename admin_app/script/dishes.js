// Mock Dish Data
const dishes = [
    {id: 1, name: "Beef Burger", category: "Mains", price: 10, quantity: 20, status: "available", description: "Classic Smash Burger.", img: "../../img/Mains/Cheeseburger.jpg"},
    {id: 2, name: "Chicken Chop", category: "Mains", price: 8, quantity: 20, status: "available", description: "Classic Chicken Delight.", img: "../../img/Mains/Chicken%20Chop.jpg"},
    {id: 3, name: "Fish and Chips", category: "Mains", price: 15, quantity: 10, status: "not availabe", description: "For the Ocean Fanatics.", img: "../../img/Mains/Fish-and-chips.jpg"},
];
...
function appendDishes (dishes) {
    ...
    const trHeadings = ["ID No.", "Dish Name", "Category", "Price", "Quantity", "Status", "Action", "Image"];
