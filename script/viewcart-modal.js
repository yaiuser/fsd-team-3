...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // const foodCards = document.querySelectorAll('.triggerDiv .edit');               // Get all food cards, the food cards have the same class when populated
